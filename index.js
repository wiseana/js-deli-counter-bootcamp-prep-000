...
function theLine(katzDeliLine) {let count=0; var output=[]; while (count<katzDeliLine.length) {output.push (`${count+1}. ${katzDeliLine[count]}`); ++count} return `The line is currently: ${output}`;}